  ...
  return (
    <Layout title="Payments">
      <div class="w-screen min-h-screen flex flex-col justify-center items-center">
        <div class="text-6xl font-semibold opacity-90">Payment Successfull</div>
        <div class="text-2xl font-semibold opacity-90 mt-6">Please check your email for the receipt</div>
